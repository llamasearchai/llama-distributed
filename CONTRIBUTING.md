# Contributing to Llama Distributed

Thank you for your interest in contributing to Llama Distributed! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Distributed:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-distributed.git
   cd llama-distributed
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-distributed.git
   ```
...
By contributing to Llama Distributed, you agree that your contributions will be licensed under the project's MIT License.
